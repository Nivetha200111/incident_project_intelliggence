export default async function handler(req, res) {
  ...
  try {
    ...
    const response = await fetch(
      `${SN_INSTANCE}/api/x_1809368_incide_0/incident_intelligence_api/project-suggestions`,
      {
        method: 'GET',
        headers: {
    ...
    return res.status(500).json({ error: 'Failed to fetch suggestions', message: err.message });
  }
}
